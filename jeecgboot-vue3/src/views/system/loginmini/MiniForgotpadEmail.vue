                ...
                <div class="aui-account aui-account-line aui-forgot">
                  <a-form-item>
                    <div class="aui-input-line">
                      <a-input type="text" :placeholder="t('sys.login.email')" v-model:value="formData.mobile" />
                    </div>
                  </a-form-item>
                  <div class="aui-input-line">
                    <a-form-item>
                      <a-input type="text" :placeholder="t('sys.login.emailCode')" v-model:value="formData.smscode" />
                    </a-form-item>
