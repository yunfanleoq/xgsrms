...
<!--      <template #action="{ record }">
    ...
    <!-- 表单区域 -->
    <XgsInterviewModal @register="registerModal" @success="handleSuccess"></XgsInterviewModal>
  </div>
</template>
...
<script lang="ts" name="xgsInviteToInterview-xgsInviteToInterview" setup>
  ...
  import XgsInviteToInterviewModal from './components/XgsInterviewModal.vue'
  ...
  const { prefixCls,tableContext,onExportXls,onImportXls } = useListPage({
      tableProps:{
           ...
           formConfig: {
              ...
              fieldMapToTime: [
                 ['interviewDate', ['interviewDate_begin', 'interviewDate_end'], 'YYYY-MM-DD HH:mm:ss'],
              ],
            },
           actionColumn: {
               width: 120,
