<template>
  <div class="paper-patent-table">
    <div class="table-operations" v-if="!disabled">
      <a-button type="primary" @click="handleAdd">
        <plus-outlined /> 新增论文专著专利
      </a-button>
    </div>
    ...
    >
      <template #bodyCell="{ column, record, index }">
        ...
        <template v-else-if="column.key === 'researchPaper'">
          <div class="content-cell" :title="record.researchPaper">
    ...
    >
      ...
      >
        <a-form-item
          ...
          name="researchPaper"
          :rules="[
            { required: true, message: '请输入论文专著专利' },
            { max: 500, message: '内容过长，请限制在5行以内' }
          ]"
        >
          <a-textarea
            v-model:value="formState.researchPaper"
            placeholder="请输入论文专著专利，不超过5行"
            :rows="5"
            :maxLength="500"
            show-count
          />
