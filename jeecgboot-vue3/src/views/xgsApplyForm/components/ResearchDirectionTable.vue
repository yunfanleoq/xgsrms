<template>
  <div class="research-direction-table">
    <div class="table-operations" v-if="!disabled">
      <a-button type="primary" @click="handleAdd">
        <plus-outlined /> 新增研究方向与专长
      </a-button>
    </div>
    ...
    >
      <template #bodyCell="{ column, record, index }">
        ...
        <template v-else-if="column.key === 'researchDirection'">
          <div class="content-cell" :title="record.researchDirection">
    ...
    >
      ...
      >
        <a-form-item
          ...
          :rules="[
            { required: true, message: '请输入研究方向与专长' },
            { max: 500, message: '内容过长，请限制在5行以内' }
          ]"
        >
          <a-textarea
            v-model:value="formState.researchDirection"
            placeholder="请输入研究方向与专长，不超过5行"
            :rows="5"
            :maxLength="500"
            show-count
          />
...
const modalTitle = ref('新增研究方向与专长');
const formRef = ref();
