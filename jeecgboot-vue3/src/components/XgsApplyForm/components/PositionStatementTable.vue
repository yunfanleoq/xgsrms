  ...
  <div class="position-statement-table">
    ...
    >
      <a-form
        ...
        :wrapper-col="{ span: 18 }"
      >
        <a-form-item label="应聘岗位陈述" name="positionDescription" :rules="[{ required: true, message: '请输入应聘岗位陈述' }]">
          <a-textarea
            v-model:value="formState.positionDescription"
            placeholder="请输入应聘岗位陈述"
            :rows="6"
            :maxlength="2000"
            show-count
          />
...
const columns = [
  { title: '应聘岗位陈述', dataIndex: 'positionDescription', key: 'positionDescription', ellipsis: true },
