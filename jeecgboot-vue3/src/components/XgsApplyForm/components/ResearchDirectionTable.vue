  ...
  <div class="research-direction-table">
    ...
    >
      <a-form
        ...
        :wrapper-col="{ span: 18 }"
      >
        <a-form-item label="研究方向与专长" name="researchDirection" :rules="[{ required: true, message: '请输入研究方向与专长' }]">
          <a-textarea
            v-model:value="formState.researchDirection"
            placeholder="请输入研究方向与专长"
            :rows="6"
            :maxlength="2000"
            show-count
          />
...
const columns = [
  { title: '研究方向与专长', dataIndex: 'researchDirection', key: 'researchDirection', ellipsis: true },
