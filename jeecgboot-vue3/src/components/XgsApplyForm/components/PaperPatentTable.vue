  ...
  <div class="paper-patent-table">
    ...
    >
      <a-form
        ...
        :wrapper-col="{ span: 18 }"
      >
        <a-form-item label="论文专著专利" name="researchPaper" :rules="[{ required: true, message: '请输入论文专著专利' }]">
          <a-textarea
            v-model:value="formState.researchPaper"
            placeholder="请输入论文专著专利"
            :rows="6"
            :maxlength="2000"
            show-count
          />
...
const columns = [
  { title: '论文专著专利', dataIndex: 'researchPaper', key: 'researchPaper', ellipsis: true },
