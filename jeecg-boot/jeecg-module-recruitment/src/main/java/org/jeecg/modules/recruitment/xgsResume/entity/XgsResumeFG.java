package org.jeecg.modules.recruitment.xgsResume.entity;
 ...
 * @Version: V1.0
 */
@ApiModel(value="xgs_resume_base对象", description="基本信息-副高")
@Data
@TableName("xgs_resume_base")
public class XgsResumeFG implements Serializable {
