...
import org.jeecg.modules.recruitment.xgsResume.vo.XgsResumeTJPage;
import org.jeecg.modules.recruitment.xgsResume.service.IXgsResumeTJService;
...
public class XgsResumeTJController {
	...
	public Result<List<Object>> queryXgsResumeResearchResultByMainId(@RequestParam(name="id",required=true) String id) {
		XgsResumeTJ xgsResumeTJ = xgsResumeTJService.getById(id);
		if(xgsResumeTJ != null && xgsResumeTJ.getResearchResult() != null) {
			List<Object> list = com.alibaba.fastjson.JSON.parseArray(xgsResumeTJ.getResearchResult(), Object.class);
	...
	public Result<List<Object>> queryXgsResumePositionDescriptionByMainId(@RequestParam(name="id",required=true) String id) {
		XgsResumeTJ xgsResumeTJ = xgsResumeTJService.getById(id);
		if(xgsResumeTJ != null && xgsResumeTJ.getPositionDescription() != null) {
			List<Object> list = com.alibaba.fastjson.JSON.parseArray(xgsResumeTJ.getPositionDescription(), Object.class);
			return Result.OK(list);
		}
		return Result.OK(new java.util.ArrayList<>());
	}
	...
	public Result<List<Object>> queryXgsResumeResearchDirectionByMainId(@RequestParam(name="id",required=true) String id) {
		XgsResumeTJ xgsResumeTJ = xgsResumeTJService.getById(id);
		if(xgsResumeTJ != null && xgsResumeTJ.getResearchDirection() != null) {
			List<Object> list = com.alibaba.fastjson.JSON.parseArray(xgsResumeTJ.getResearchDirection(), Object.class);
			return Result.OK(list);
		}
		return Result.OK(new java.util.ArrayList<>());
	}
	...
	public Result<List<Object>> queryXgsResumeResearchPaperByMainId(@RequestParam(name="id",required=true) String id) {
		XgsResumeTJ xgsResumeTJ = xgsResumeTJService.getById(id);
		if(xgsResumeTJ != null && xgsResumeTJ.getResearchPaper() != null) {
			List<Object> list = com.alibaba.fastjson.JSON.parseArray(xgsResumeTJ.getResearchPaper(), Object.class);
			return Result.OK(list);
		}
		return Result.OK(new java.util.ArrayList<>());
	}
