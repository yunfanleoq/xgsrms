			...
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input type="number" placeholder="请输入申请状态" v-model="model.status"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/positions/xgsPositionApply/queryById",
                  add: "/positions/xgsPositionApply/add",
