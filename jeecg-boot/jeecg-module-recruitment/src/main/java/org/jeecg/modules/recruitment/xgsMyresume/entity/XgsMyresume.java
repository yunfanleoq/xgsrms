package org.jeecg.modules.recruitment.xgsMyresume.entity;
 ...
 */
@Data
@TableName("xgs_myresume")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="xgs_myresume对象", description="简历列表")
public class XgsMyresume implements Serializable {
