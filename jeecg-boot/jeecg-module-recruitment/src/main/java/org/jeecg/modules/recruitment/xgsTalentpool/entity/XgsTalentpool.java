package org.jeecg.modules.recruitment.xgsTalentpool.entity;
 ...
 */
@Data
@TableName("xgs_talentpool")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="xgs_talentpool对象", description="人才库")
public class XgsTalentpool implements Serializable {
