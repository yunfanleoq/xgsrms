package org.jeecg.modules.demo.xgsPositionPublish.entity;
 ...
 */
@Data
@TableName("xgs_position_publish")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="xgs_position_publish对象", description="岗位发布")
public class XgsPositionPublish implements Serializable {
	...
	/**招聘部门*/
	@Excel(name = "招聘部门", width = 15)
    @ApiModelProperty(value = "招聘部门")
    private java.lang.String dept;
	/**课题组*/
	@Excel(name = "课题组", width = 15)
