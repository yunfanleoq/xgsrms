...
import org.jeecg.modules.demo.xgsJournalism.entity.XgsIntroduce;
import org.jeecg.modules.demo.xgsJournalism.service.IXgsIntroduceService;
...
@Api(tags="机构概况")
@RestController
@RequestMapping("/xgsJournalism/xgsIntroduce")
@Slf4j
public class XgsIntroduceController extends JeecgController<XgsIntroduce, IXgsIntroduceService> {
	...
	@RequiresPermissions("xgsJournalism:xgs_introduce:add")
	...
	@RequiresPermissions("xgsJournalism:xgs_introduce:edit")
	...
	@RequiresPermissions("xgsJournalism:xgs_introduce:delete")
	...
	@RequiresPermissions("xgsJournalism:xgs_introduce:deleteBatch")
    ...
    * @param xgsIntroduce
    */
    @RequiresPermissions("xgsJournalism:xgs_introduce:exportXls")
    ...
    * @return
    */
    @RequiresPermissions("xgsJournalism:xgs_introduce:importExcel")
